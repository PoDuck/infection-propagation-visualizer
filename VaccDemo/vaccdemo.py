...
# Form implementation generated from reading ui file 'vaccdemo.ui'
#
# Created: Thu May  2 09:14:00 2013
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.numPeopleCombo = QtGui.QComboBox(self.layoutWidget)
        self.numPeopleCombo.setAccessibleName(_fromUtf8(""))
        self.numPeopleCombo.setObjectName(_fromUtf8("numPeopleCombo"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(0, _fromUtf8("400"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(1, _fromUtf8("361"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(2, _fromUtf8("324"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(3, _fromUtf8("289"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(4, _fromUtf8("256"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(5, _fromUtf8("225"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(6, _fromUtf8("196"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(7, _fromUtf8("144"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(8, _fromUtf8("121"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(9, _fromUtf8("100"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(10, _fromUtf8("81"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(11, _fromUtf8("64"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(12, _fromUtf8("49"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(13, _fromUtf8("36"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(14, _fromUtf8("25"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(15, _fromUtf8("16"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(16, _fromUtf8("9"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(17, _fromUtf8("4"))
        self.gridLayout.addWidget(self.numPeopleCombo, 0, 1, 1, 1)
        ...
        Dialog.setTabOrder(self.numPeopleCombo, self.numVaccinatedBox)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate("Dialog", "Total People:", None, QtGui.QApplication.UnicodeUTF8))
