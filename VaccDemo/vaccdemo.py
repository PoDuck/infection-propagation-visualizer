...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.numPeopleCombo.setItemText(0, _fromUtf8("100"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(1, _fromUtf8("81"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(2, _fromUtf8("64"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(3, _fromUtf8("49"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(4, _fromUtf8("36"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(5, _fromUtf8("25"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(6, _fromUtf8("16"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(7, _fromUtf8("9"))
        self.numPeopleCombo.addItem(_fromUtf8(""))
        self.numPeopleCombo.setItemText(8, _fromUtf8("4"))
